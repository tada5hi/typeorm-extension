import{_ as s,o as a,c as n,Q as p}from"./chunks/framework.6ee49df6.js";const h=JSON.parse('{"title":"Database","description":"","frontmatter":{},"headers":[],"relativePath":"guide/database.md","filePath":"guide/database.md"}'),l={name:"guide/database.md"},o=p(`<h1 id="database" tabindex="-1">Database <a class="header-anchor" href="#database" aria-label="Permalink to &quot;Database&quot;">​</a></h1><p>An alternative to the CLI variant, is to <code>create</code> the database in the code base during the runtime of the application. Therefore, provide the <code>DataSourceOptions</code> for the DataSource manually, or let it be created automatically:</p><h2 id="create" tabindex="-1">Create <a class="header-anchor" href="#create" aria-label="Permalink to &quot;Create&quot;">​</a></h2><p><strong><code>Example #1</code></strong></p><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { </span></span>
