...
The codec owns both directions. A client builds the wire form of the request example above with `encode`,
from a typed query instead of string concatenation (no registry needed on the client):
